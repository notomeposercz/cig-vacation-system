    ...
    public function requestFormSucceeded(Form $form, \stdClass $values): void
{
    ...
    try {
        ...
        // Toto je normální ukončení (redirect, sendJson, atd.) - necháme projít
        throw $e;
    } catch (\Exception $e) {
        // Pouze skutečné chyby
        \Tracy\Debugger::log("SKUTEČNÁ CHYBA při zpracování žádosti: " . $e->getMessage() . "\n" . $e->getTraceAsString(), 'vacation-error');
